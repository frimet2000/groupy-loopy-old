...
const translations = {
  en: {
    ...
    // Trek Day View
    myTrekDays: "My Trek Days",
    trekDayExperience: "A futuristic and emotional trek experience",
    days: "days",
    memorials: "memorials",
    ...
    routeMap: "Route Map",
    memorial: "Memorial",
    organizersManagers: "Organizers & Managers",
    info: "Info",
    map: "Map",
    estimatedWeather: "Estimated Weather",
    recommendedEquipment: "Recommended Equipment",
    dateOfFall: "Date of Fall",
    placeOfFall: "Place of Fall",
    dedications: "Dedications",
    close: "Close",
    participantsSharing: "participants sharing live location",
    elevation: "Elevation",
    highest: "Highest",
    lowest: "Lowest",
  ...
  he: {
    ...
    // Trek Day View
    myTrekDays: "ימי הטיול שלי",
    trekDayExperience: "חווית טיול עתידנית ומרגשת",
    days: "ימים",
    memorials: "הנצחות",
    ...
    routeMap: "מפת מסלול",
    memorial: "הנצחה",
    organizersManagers: "מנהלים ומאבטחים",
    info: "מידע",
    map: "מפה",
    estimatedWeather: "מזג אוויר משוער",
    recommendedEquipment: "ציוד מומלץ",
    dateOfFall: "תאריך נפילה",
    placeOfFall: "מקום נפילה",
    dedications: "הקדשות",
    close: "סגור",
    participantsSharing: "משתתפים משתפים את מיקומם בזמן אמת",
    elevation: "עליה (מ״)",
    highest: "נקודה גבוהה",
    lowest: "נקודה נמוכה",
  ...
  fr: {
    ...
    // Trek Day View
    myTrekDays: "Mes jours de trek",
    trekDayExperience: "Une expérience de trek futuriste et émotionnelle",
    days: "jours",
    memorials: "mémoriaux",
    ...
    memorial: "Mémorial",
    organizersManagers: "Organisateurs",
    info: "Info",
    map: "Carte",
    estimatedWeather: "Météo estimée",
    recommendedEquipment: "Équipement recommandé",
    dateOfFall: "Date de chute",
    placeOfFall: "Lieu de chute",
    dedications: "Dédicaces",
    close: "Fermer",
    participantsSharing: "participants partagent leur position",
    elevation: "Dénivelé",
    highest: "Plus haut",
    lowest: "Plus bas",
  ...
  es: {
    ...
    // Trek Day View
    myTrekDays: "Mis días de caminata",
    trekDayExperience: "Una experiencia de caminata futurista y emotiva",
    days: "días",
    ...
    memorial: "Memorial",
    organizersManagers: "Organizadores",
    info: "Info",
    map: "Mapa",
    estimatedWeather: "Clima estimado",
    recommendedEquipment: "Equipo recomendado",
    dateOfFall: "Fecha de caída",
    placeOfFall: "Lugar de caída",
    dedications: "Dedicatorias",
    close: "Cerrar",
    participantsSharing: "participantes compartiendo ubicación",
    elevation: "Elevación",
    highest: "Más alto",
    lowest: "Más bajo",
  ...
  de: {
    ...
    // Trek Day View
    myTrekDays: "Meine Trek-Tage",
    trekDayExperience: "Ein futuristisches und emotionales Trek-Erlebnis",
    days: "Tage",
  ...
  it: {
    ...
    // Trek Day View
    myTrekDays: "I miei giorni di trekking",
    trekDayExperience: "Un'esperienza di trekking futuristica ed emozionante",
    days: "giorni",
    memorials: "memoriali",
    ...
    memorial: "Memoriale",
    organizersManagers: "Organizzatori",
    info: "Info",
    map: "Mappa",
    estimatedWeather: "Meteo stimato",
    recommendedEquipment: "Attrezzatura consigliata",
    dateOfFall: "Data della caduta",
    placeOfFall: "Luogo della caduta",
    dedications: "Dediche",
    close: "Chiudi",
    participantsSharing: "partecipanti condividono posizione",
  ...
  ru: {
    ...
    // Trek Day View
    myTrekDays: "Мои дни похода",
    trekDayExperience: "Футуристический и эмоциональный опыт похода",
    days: "дней",
    memorials: "мемориалы",
    ...
    memorial: "Мемориал",
    organizersManagers: "Организаторы",
    info: "Инфо",
    map: "Карта",
    estimatedWeather: "Прогноз погоды",
    recommendedEquipment: "Рекомендуемое оборудование",
    dateOfFall: "Дата падения",
    placeOfFall: "Место падения",
    dedications: "Посвящения",
    close: "Закрыть",
    participantsSharing: "участников делятся местоположением",
